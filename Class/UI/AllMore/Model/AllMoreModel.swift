...
/**
 메뉴 리스트별 인포 정보 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.03.07
*/
...
/**
 메뉴 리스트 타입 정보 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.05.02
*/
...
/**
 전체 상세정보를 모델 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.03.07
*/
class AllMoreModel : BaseViewModel{
    ...
    /**
     메뉴 리스트별 디스플레이 할 정보를 넘깁니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.07
     - Parameters:
    ...
    /**
     전체 탭 상세 정보를 서버에 요청 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.09
     - Parameters:False
     - Throws: False
     - Returns:
