...
/**
 입 최초 실행시 인트로 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.03.20
 */
class IntroViewController: BaseViewController {
    ...
    // MARK: - 지원 메서드 입니다.
    /**
     앱 기본 체크 사항을 확인 하고 디스플레이 합니다..  ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.20
     - Parameters:False
     - Throws: False
     - Returns:False
    ...
    /**
     앱 업데이트 및 변경사항을 서버 요청후 체크 합니다..  ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.20
     - Parameters:False
     - Throws: False
     - Returns:False
                    ...
                    if version._version! > APP_VERSION
                    {
                        ...
                        if version._compulsion_update == "N"
                        {
                            ...
                            alert?.addAlertBtn(btnTitleText: "다음에하기", completion: { result in
                                /// 접근 권한 안내 팝업 오픈 합니다. ( J.D.H VER : 2.0.0 )
    ...
    /**
     OKPay 앱을 시작 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.20
     - Throws: False
     - Returns:False
     */
    ...
    /**
     메인 화면 디스플레이 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.04
     - Parameters:
