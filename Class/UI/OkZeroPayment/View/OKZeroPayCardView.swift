...
/**
 카드 뷰어에 버튼 이벤트 값 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.06.15
 */
...
/**
 디스플레이 타입  값 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.06.15
 */
...
class OKZeroPayCardView: UIView {
    ...
    //MARK: - 지원 메서드 입니다.
    /**
     카드 디스플레이 할 정보를 받아 설정 합니다. ( J.D.H VER : 2.0.0 )
    ...
    /**
     그라데이션 컬러값을 받아 카드 배경에 컬러를 추가 합니다. ( J.D.H VER : 2.0.0 )
