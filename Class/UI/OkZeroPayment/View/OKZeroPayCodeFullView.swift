...
/**
 제로페이 결제코드 전체화면 뷰어 입니다.  ( J.D.H VER : 2.0.0 )
 - Date: 2023.04.27
 */
class OKZeroPayCodeFullView: UIView {
    ...
    //MARK: - 지원 메서드 입니다.
    /**
     제로페이 결제코드 전체화면 초기화 합니다.  ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.27
     */
    ...
    /**
     전체 화면에 코드정보를 빈값으로 초기화 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.27
     - Parameters:
    ...
    /**
     결제 코드를 전체 화면에 설정 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.27
     - Parameters:
        - codeType : 디스플레이 할 타입을 받습니다. ( .barcode : 바코드 타입 , .qrcode : QRCode 타입 )
        - code : 디스플레이 할 코드 정보 입니다.
