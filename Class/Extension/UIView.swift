...
extension UIView
{
    ...
    public func applyHexagonMask() {
        let maskPath        = UIBezierPath(square: self.bounds, numberOfSides: 6, cornerRadius: 0.0)
        maskPath?.rotate(degree: 30)
