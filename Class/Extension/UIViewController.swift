...
extension UIViewController {
    ...
    /**
     컨트롤러 데이터 초기화 메서드 입니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.07.10
     - Parameters:False
     - Throws: False
     - Returns:False
    ...
    /**
     컨트롤러를 받아 다음 페이지로 이동 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.12
     - Parameters:
    ...
    /**
     컨트롤로 현 페이지를 종료 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.17
     - Parameters:
        - animated : 효과 여부 입니다.
        - animationType : 페이지 이동할 효과 정보를 받습니다.
    ...
    /**
     컨트롤로 0번 페이지로 이동합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.17
     - Parameters:
        - animated : 효과 여부 입니다.
        - animationType : 페이지 이동할 효과 정보를 받습니다.
    ...
    /**
     present로 연결된 ViewControllers 를 0번째 Root ViewController 이동 하도록 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.05.03
     - Parameters:
