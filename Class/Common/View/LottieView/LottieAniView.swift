...
/**
 Lottie.json 파일 디스플레이 뷰어입니다. ( J.D.H VER : 2.0.0 )
 - Date: 2023.05.04
 */
@objc class LottieAniView: UIView {
    ...
    // MARK: - override
    /**
     설정된 로띠 화면 layout 을 전체 화면으로 연결 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.05.04
     */
    ...
    // MARK: - 지원 메서드 입니다.
    /**
     연결할 기본 정보를 받아 설정 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.05.04
     - Parameters:
        - name : 연결 할 파일명 입니다.
