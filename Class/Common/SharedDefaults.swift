...
/**
 앱내 저장하는 UserDefaults  입니다. ( J.D.H VER : 2.0.0 )
 - Date: 2023.03.27
 */
class SharedDefaults {
    ...
    //MARK: - 지원 메서드 입니다.
    /**
     키체인 연결 custItem 타입의 데이터를 가져 옵니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.31
     - Parameters:False
     - Throws: False
     - Returns:
    ...
    /**
     키체인에 custItem 타입의 데이터를 추가 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.31
     - Parameters:
    ...
    /**
     키체인에 문자형 데이터를 리턴 합니다. ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.31
     - Parameters:
