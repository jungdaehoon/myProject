...
/**
 웹 링크 연결시 진행 타입 값입니다. ( J.D.H VER : 2.0.0 )
 - Date: 2023.06.23
*/
...
/**
 기본 베이스 웹 컨트롤뷰 입니다. ( J.D.H VER : 2.0.0 )
 - Date: 2023.03.20
 */
class BaseWebViewController: UIViewController {
    ...
    //MARK: - 지원 메서드 입니다.
    /**
     WebView 를 초기화 합니다.. ( J.D.H VER : 2.0.0 )
    ...
    /**
     웹뷰 새로고침 이벤트 요청 액션 입니다.  ( J.D.H VER : 2.0.0 )
     - Date: 2023.06.08
     - Parameters:
    ...
    /**
     탭 이동시 현 페이지가 빈화면으로 새로고침을 해야하는 상황인지를 체크후 URL 로드 합니다.   ( J.D.H VER : 2.0.0 )
     - Date: 2023.04.21
     - Parameters:
    ...
    /**
     URL 정보를 받아 화면에 디스플레이 합니다.   ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.20
     - Parameters:
        - url : 디스플레이할 웹 페이지 입니다.
    ...
    /**
     웹 페이지를 빈화면으로 설정 합니다 ( J.D.H VER : 2.0.0 )
     - Date: 2023.03.20
     - Parameters:False
     - Returns:False
     */
...
extension BaseWebViewController: WKScriptMessageHandler {
    /**
     Web 에서 ScriptMessage 받는 메서드 입니다. ( J.D.H VER : 2.0.0 )
