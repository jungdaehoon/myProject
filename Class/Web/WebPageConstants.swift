...
class WebPageConstants {
    ...
    /// OK 마켓 페이지 입니다.
    static let URL_GIFT_LIST                    = baseURL + "myp/mypGifticonList.do"
    /// OK 머니 페이지 입니다.
    ...
    /// 이벤트 페이지 입니다.
    static let URL_EVENT_LIST                   = baseURL + "all/eventList.do"
    /// 올리고 포인트 안내 페이지 입니다.
    static let URL_POINT_INFO                   = baseURL + "all/pointInfo.do"
    /// FAQ 페이지 입니다.
    static let URL_FAQ_LIST                     = baseURL + "all/faqList.do"
    /// 카카오톡 문의하기 페이지 입니다.
    static let URL_KAKAO_CONTACT                = "https://pf.kakao.com/_jxcxgaK"
    /// 올림pick 페이지 입니다.
    static let URL_OLIMPICK_LIST                = baseURL + "community/communityQuiz.do"
    /// 친구 초대 페이지 입니다.
    static let URL_RECOMMEND_USER               = baseURL + "all/recommUser.do"
    /// 계좌 재인증 페이지 입니다.
