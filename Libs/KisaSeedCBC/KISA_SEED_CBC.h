...
extern int encrytSeedCBC( IN BYTE *pbszPlainText,OUT BYTE *pbszCipherText );
extern int decrytSeedCBC( IN BYTE *pbszCipherText,OUT BYTE *pbszPlainText );
extern int encrytKeyIVSeedCBC( IN BYTE *pbszUserKey, IN BYTE *pbszIV, IN BYTE *pbszPlainText,OUT BYTE *pbszCipherText );
extern int decrytKeyIVSeedCBC( IN BYTE *pbszUserKey, IN BYTE *pbszIV, IN BYTE *pbszCipherText,OUT BYTE *pbszPlainText );
